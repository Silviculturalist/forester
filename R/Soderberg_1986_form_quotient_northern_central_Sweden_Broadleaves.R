...
#'
#' @examples
Soderberg_1986_form_quotient_northern_central_Sweden_Broadleaves <- function(
  diameter_cm,
  ...
  return(
    exp(
      -0.75461E+02*(1/((diameter_cm*10) + 50))+ #diameter in mm
        -0.22422E+02*(1/(age_at_breast_height+10))+
        +0.23326E+03*((1/(age_at_breast_height+10))^2)+
        -0.34112E-02*age_at_breast_height+
        +0.93785E-03*spruce*SI100*10+#m to dm.
        +0.12420E-02*pine*SI100*10+ #m to dm.
        +0.18241E-01*Basal_area_plot_m2_ha+
        -0.16138E-03*(Basal_area_plot_m2_ha^2)+
