...
Soderberg_1986_BA_increment_northern_central_Sweden_Broadleaves <- function(
  ...
  thinning <- ifelse(thinned==FALSE,
                     (#unthinned
                       -0.2732E-01*Basal_area_plot_m2_ha+
                         +0.32095E-03*(Basal_area_plot_m2_ha^2)
                     ...
                     ifelse(thinned==TRUE & last_thinned<5,
                            (#thinned within 5 years
                              -0.19331E-01*Basal_area_plot_m2_ha
                            ),
  ...
  return(
    exp(
      +0.11208E+01*log(basal_area_of_tree_cm2)+
        +0.48728E+02*(1/(age_at_breast_height+10))+
        +thinning+
