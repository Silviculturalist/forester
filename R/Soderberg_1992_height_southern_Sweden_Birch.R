#' Height function for Birch in southern Sweden from Söderberg 1992.
#'
#' @source Söderberg, U. (1992) Funktioner för skogsindelning: Höjd, formhöjd och barktjocklek för enskilda träd. / Functions for forest management: Height, form height and bark thickness of individual trees. Report 52. Dept. of Forest Survey. Swedish University of Agricultural Sciences. ISSN 0348-0496. p. 39.
#'
#' @description
...
#'
#' Spread about the function sf = 0.164
#'
...
Soderberg_1992_height_southern_Sweden_Birch <- function(
  ...
  return(
    exp(
      -0.22552E3*(1/((diameter_cm*10)+50))+#Diameter cm should be in mm.
        +0.39171E4*((1/((diameter_cm*10)+50))^2)+ #Diameter cm should be in mm.
        +0.17264E-2*total_age_stand+
        -0.11572E-4*(total_age_stand^2)+
