#' Double bark thickness in northern Sweden for Scots Pine  from Söderberg 1992.
#'
#' @source Söderberg, U. (1992) Funktioner för skogsindelning: Höjd, formhöjd och barktjocklek för enskilda träd. / Functions for forest management: Height, form height and bark thickness of individual trees. Report 52. Dept. of Forest Survey. Swedish University of Agricultural Sciences. ISSN 0348-0496. p. 61.
#'
#' @description
...
Soderberg_1992_double_bark_northern_Sweden_Pine <- function(
  ...
  return(
    exp(
      -0.40225E3*(1/((diameter_cm*10)+50))+#Diameter cm should be in mm.
        +0.15037E5*((1/((diameter_cm*10)+50))^2)+ #Diameter cm should be in mm.
        +0.44577E-3*total_age_stand+
