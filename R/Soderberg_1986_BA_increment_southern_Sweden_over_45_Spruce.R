...
#'
#' @examples
Soderberg_1986_BA_increment_southern_Sweden_over_45_Spruce <- function(
  diameter_cm,
  ...
  thinning <- ifelse(thinned==FALSE,
                     (#unthinned
                       -0.57054E-01*Basal_area_plot_m2_ha+
                         +0.68177E-03*(Basal_area_plot_m2_ha^2)
                     ...
                     ifelse(thinned==TRUE & last_thinned<5,
                            (#thinned within 5 years
                              -0.54388E-01*Basal_area_plot_m2_ha+
                                +0.68291E-03*(Basal_area_plot_m2_ha^2)
                            )
                            ...
                            (#thinned longer ago than 5 years.
                              -0.55215E-01*Basal_area_plot_m2_ha+
                                +0.67161E-03*(Basal_area_plot_m2_ha^2)
