#' Elfving Basal Area Development Functions
#'
#'@description This function has been superceded by [forester::elfving_gy_utveckling_correction]
#'
#'The dependent variable is 5 yr. increment of \strong{squared} diameter at breast height, cm^2.
#'
#'@seealso [elfving_gy_utveckling_correction]
#'
#' @source from the manuscript Elfving, B. (2001). "Individual-tree basal area growth functions based on data from permanent inventory plots in Sweden" (Unpubl.)
