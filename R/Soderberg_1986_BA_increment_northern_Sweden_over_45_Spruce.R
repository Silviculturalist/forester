...
#'
#' @examples
Soderberg_1986_BA_increment_northern_Sweden_over_45_Spruce <- function(
  diameter_cm,
  ...
  thinning <- ifelse(thinned==FALSE,
                     (#unthinned
                       -0.25065E-01*Basal_area_plot_m2_ha+
                         +0.17057E-03*(Basal_area_plot_m2_ha^2)
                     ...
                     ifelse(thinned==TRUE & last_thinned<5,
                            (#thinned within 5 years
                              -0.79174E-01*Basal_area_plot_m2_ha+
                                -0.18978E-03*(Basal_area_plot_m2_ha^2)
                            )
                            ...
                            (#thinned longer ago than 5 years.
                              -0.13173E-01*Basal_area_plot_m2_ha+
                                -0.19558E-03*(Basal_area_plot_m2_ha^2)
  ...
  return(
    exp(
      +0.10342E+01*log(basal_area_of_tree_cm2)+
        ...
        +0.16924E+03*(1/(age_at_breast_height+10))+
        -0.36209E+04*((1/(age_at_breast_height+10))^2)+
        +thinning+
