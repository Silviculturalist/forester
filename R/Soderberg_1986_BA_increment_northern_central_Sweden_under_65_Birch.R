#' 5 year Basal area increment over bark, Birch, northern and central Sweden, under 65 years at breast height from Söderberg (1986)
#'
...
#'
#' @examples
Soderberg_1986_BA_increment_northern_central_Sweden_under_65_Birch <- function(
  diameter_cm,
  ...
  thinning <- ifelse(thinned==FALSE,
                     (#unthinned
                       -0.72642E-01*Basal_area_plot_m2_ha+
                         +0.11651E-02*(Basal_area_plot_m2_ha^2)
                     ...
                     ifelse(thinned==TRUE & last_thinned<5,
                            (#thinned within 5 years
                              -0.45533E-01*Basal_area_plot_m2_ha+
                                +0.42222E-03*(Basal_area_plot_m2_ha^2)
                            )
                            ...
                            (#thinned longer ago than 5 years.
                              -0.51405E-01*Basal_area_plot_m2_ha+
                                +0.54316E-03*(Basal_area_plot_m2_ha^2)
  ...
  return(
    exp(
      +0.10356E+01*log(basal_area_of_tree_cm2)+
        +0.11677E+03*(1/(age_at_breast_height+10))+
        -0.10643E+04*((1/(age_at_breast_height+10))^2)+
        +thinning+
