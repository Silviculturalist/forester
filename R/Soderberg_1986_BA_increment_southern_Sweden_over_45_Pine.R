...
#'
#' @examples
Soderberg_1986_BA_increment_southern_Sweden_over_45_Pine <- function(
  diameter_cm,
  ...
  thinning <- ifelse(thinned==FALSE,
                     (#unthinned
                       -0.38635E-01*Basal_area_plot_m2_ha+
                         +0.42831E-03*(Basal_area_plot_m2_ha^2)
                     ...
                     ifelse(thinned==TRUE & last_thinned<5,
                            (#thinned within 5 years
                              -0.35844E-01*Basal_area_plot_m2_ha+
                                +0.42792E-03*(Basal_area_plot_m2_ha^2)
                            )
                            ...
                            (#thinned longer ago than 5 years.
                              -0.37468E-01*Basal_area_plot_m2_ha+
                                +0.36891E-03*(Basal_area_plot_m2_ha^2)
  ...
  return(
    exp(
      +0.85280E+00*log(basal_area_of_tree_cm2)+
        ...
        +0.14841E+03*(1/(age_at_breast_height+10))+
        -0.27409E+04*((1/(age_at_breast_height+10))^2)+
        +thinning+
