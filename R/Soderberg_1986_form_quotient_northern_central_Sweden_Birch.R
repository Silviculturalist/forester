...
#'
#' @examples
Soderberg_1986_form_quotient_northern_central_Sweden_Birch <- function(
  diameter_cm,
  ...
  return(
    exp(
      -0.18780E+03*(1/((diameter_cm*10) + 50))+ #diameter in mm
        +0.41264E+04*((1/((diameter_cm*10) + 50))^2)+ #diameter in mm
        +0.49071E+01*(1/(age_at_breast_height+10))+
        -0.38410E-01*(diameter_cm*10/age_at_breast_height)+ #diameter in mm
        +0.73517E-03*spruce*SI100*10+#m to dm.
        +0.58577E-03*pine*SI100*10+ #m to dm.
        +0.16827E-01*Basal_area_plot_m2_ha+
        -0.17158E-03*(Basal_area_plot_m2_ha^2)+
