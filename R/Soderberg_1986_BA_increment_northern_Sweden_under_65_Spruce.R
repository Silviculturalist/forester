...
#' @param Basal_area_Pine_m2_ha Basal area Spruce on the plot, m^2 / ha.
...
#'
#' @examples
Soderberg_1986_BA_increment_northern_Sweden_under_65_Spruce <- function(
  diameter_cm,
  ...
  thinning <- ifelse(thinned==FALSE,
                     (#unthinned
                       -0.36090E-01*Basal_area_plot_m2_ha+
                         +0.36083E-03*(Basal_area_plot_m2_ha^2)
                     ...
                     ifelse(thinned==TRUE & last_thinned<5,
                            (#thinned within 5 years
                              -0.32110E-01*Basal_area_plot_m2_ha+
                                +0.51283E-03*(Basal_area_plot_m2_ha^2)
                            )
                            ...
                            (#thinned longer ago than 5 years.
                              -0.22616E-01*Basal_area_plot_m2_ha+
                                +0.46227E-05*(Basal_area_plot_m2_ha^2)
  ...
  return(
    exp(
      +0.11503E+01*log(basal_area_of_tree_cm2)+
        ...
        +0.70512E+02*(1/(age_at_breast_height+10))+
        -0.31435E+03*((1/(age_at_breast_height+10))^2)+
        +thinning+
