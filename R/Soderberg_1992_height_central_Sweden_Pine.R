#' Height function for Scots Pine in central Sweden from Söderberg 1992.
#'
#' @source Söderberg, U. (1992) Funktioner för skogsindelning: Höjd, formhöjd och barktjocklek för enskilda träd. / Functions for forest management: Height, form height and bark thickness of individual trees. Report 52. Dept. of Forest Survey. Swedish University of Agricultural Sciences. ISSN 0348-0496. p. 34.
#'
#' @description
...
#'
#' Spread about the function sf = 0.137
#'
#' sf/Spread about the mean = 0.34
#'
...
Soderberg_1992_height_central_Sweden_Pine <- function(
  ...
  return(
    exp(
      -0.29249E3*(1/((diameter_cm*10)+50))+#Diameter cm should be in mm.
        +0.61832E4*((1/((diameter_cm*10)+50))^2)+ #Diameter cm should be in mm.
        +0.52675E-2*total_age_stand+
        -0.25358E-4*(total_age_stand^2)+
