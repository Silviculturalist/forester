...
#'
#' @examples
Soderberg_1986_BA_increment_northern_Sweden_over_45_Pine <- function(
  diameter_cm,
  ...
  thinning <- ifelse(thinned==FALSE,
                     (#unthinned
                       -0.62615E-01*Basal_area_plot_m2_ha+
                         +0.70095E-03*(Basal_area_plot_m2_ha^2)
                     ...
                     ifelse(thinned==TRUE & last_thinned<5,
                            (#thinned within 5 years
                              -0.48420E-01*Basal_area_plot_m2_ha+
                                +0.46192E-03*(Basal_area_plot_m2_ha^2)
                            )
                            ...
                            (#thinned longer ago than 5 years.
                              -0.52634E-01*Basal_area_plot_m2_ha+
                                +0.53348E-03*(Basal_area_plot_m2_ha^2)
  ...
  return(
    exp(
      +0.10633E+01*log(basal_area_of_tree_cm2)+
        ...
        +0.15859E+03*(1/(age_at_breast_height+10))+
        -0.36056E+04*((1/(age_at_breast_height+10))^2)+
        thinning+
