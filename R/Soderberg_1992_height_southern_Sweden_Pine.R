#' Height function for Scots Pine in southern Sweden from Söderberg 1992.
#'
#' @source Söderberg, U. (1992) Funktioner för skogsindelning: Höjd, formhöjd och barktjocklek för enskilda träd. / Functions for forest management: Height, form height and bark thickness of individual trees. Report 52. Dept. of Forest Survey. Swedish University of Agricultural Sciences. ISSN 0348-0496. p. 35.
#'
#' @description
...
#'
#' Spread about the function sf = 0.159
#'
#' sf/Spread about the mean = 0.40
#'
...
Soderberg_1992_height_southern_Sweden_Pine <- function(
  ...
  return(
    exp(
      -0.30345E3*(1/((diameter_cm*10)+50))+#Diameter cm should be in mm.
        +0.88427E4*((1/((diameter_cm*10)+50))^2)+ #Diameter cm should be in mm.
        +0.68724E-2*total_age_stand+
        -0.38585E-4*(total_age_stand^2)+
