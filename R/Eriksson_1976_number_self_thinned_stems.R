...
#' @param basal_area_m2_ha_before_thinning Basal area above bark m2/ha before thinning.
#'
#' @return numeric.
#' @export
#'
...
Eriksson_1976_number_self_thinned_stems <- function(dominant_height_m,
  ...
  basal_area_weighted_mean_diameter <- basal_area_weighted_mean_diameter_cm(basal_area_m2_ha = basal_area_m2_ha_before_thinning,
