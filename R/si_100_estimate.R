...
#'
#' @examples
#' si_100_estimate(species="NorwaySpruce",age=30, height=6.2)
si_100_estimate <- function(species=c("NorwaySpruce","ScotsPine","Larch","Beech","Oak","Birch","AlnusIncana","AlnusGlutinosa","Aspen"),
                           age, height){
