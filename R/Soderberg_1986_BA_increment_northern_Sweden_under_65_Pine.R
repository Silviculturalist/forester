...
#'
#' @examples
Soderberg_1986_BA_increment_northern_Sweden_under_65_Pine <- function(
  diameter_cm,
  ...
  thinning <- ifelse(thinned==FALSE,
                     (#unthinned
                       -0.66243E-01*Basal_area_plot_m2_ha+
                       +0.75292E-03*(Basal_area_plot_m2_ha^2)
                     ...
                     ifelse(thinned==TRUE & last_thinned<5,
                            (#thinned within 5 years
                              -0.66400E-01*Basal_area_plot_m2_ha+
                              +0.89623E-03*(Basal_area_plot_m2_ha^2)
                            )
                            ...
                            (#thinned longer ago than 5 years.
                              -0.54112E-01*Basal_area_plot_m2_ha+
                              +0.43791E-03*(Basal_area_plot_m2_ha^2)
  ...
  return(
    exp(
      ...
      -0.40367E+01*(log(basal_area_of_tree_cm2)/(age_at_breast_height+10))+
      +0.77769E+02*(1/(age_at_breast_height+10))+
      -0.19198E+03*((1/(age_at_breast_height+10))^2)+
      thinning+
