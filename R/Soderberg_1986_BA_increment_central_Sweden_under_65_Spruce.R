...
Soderberg_1986_BA_increment_central_Sweden_under_65_Spruce <- function(
  ...
  thinning <- ifelse(thinned==FALSE,
                     (#unthinned
                       -0.49683E-01*Basal_area_plot_m2_ha+
                         +0.41229E-03*(Basal_area_plot_m2_ha^2)
                     ...
                     ifelse(thinned==TRUE & last_thinned<5,
                            (#thinned within 5 years
                              -0.33745E-01*Basal_area_plot_m2_ha+
                                +0.21671E-03*(Basal_area_plot_m2_ha^2)
                            )
                            ...
                            (#thinned longer ago than 5 years.
                              -0.38862E-01*Basal_area_plot_m2_ha+
                                +0.17195E-03*(Basal_area_plot_m2_ha^2)
  ...
  return(
    exp(
      +0.14711E+01*log(basal_area_of_tree_cm2)+
        ...
        -0.79926E+01*(log(basal_area_of_tree_cm2)/(age_at_breast_height+10))+
        +0.12577E+03*(1/(age_at_breast_height+10))+
        -0.53325E+03*((1/(age_at_breast_height+10))^2)+
        +thinning+
