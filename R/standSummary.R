standSummary <- function(siteData,treelistData, managementData){
  ...
  stand_summary <- list(StandID, Main_cohort_age, Main_cohort_mean_height,Main_cohort_10percent_height,N_species_wise_per_ha,N_total_trees_per_ha,standing_volume_specieswise_per_ha,management_list)
