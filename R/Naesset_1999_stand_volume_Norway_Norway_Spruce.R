...
#' @param SI40 Site Index H40 from Tveite 1977. e.g. [Tveite_1977_height_trajectory_Norway_Norway_Spruce()]
#'
#'
...
Naesset_1999_stand_volume_Norway_Norway_Spruce <- function(
  ...
  if(SI40<6) warning("SIH40 below lower limit (H40 = 6 m)")
  if(mean_height_Lorey<6) warning("Basal area below lower limit (6 m)")
  return(
    exp(log(0.6031) + 0.9905*log(BA_m2_ha) + 0.8407*log(mean_height_Lorey) + 0.0995*log(SI40))
  )
}
